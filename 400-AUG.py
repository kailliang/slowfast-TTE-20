...
data_root = '/home/k/kai/data/400-AUG-TTE-20'
batch_size = 10
epochs = 50
save_root = '/home/k/kai/CheckPoints/400-AUG-TTE_20_Batch_10_02'
...
for epoch in range(1, epochs + 1):
    ...
    if top_1 > best_acc:
        best_acc = top_1
        torch.save(slow_fast.state_dict(), '{}/slow_fast_400-AUG-TTE_20_Batch_10_02.pth'.format(save_root))
